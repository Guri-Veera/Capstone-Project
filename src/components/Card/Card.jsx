...
function Card({
  ...
  return (
    <div className='flex items-center xs:w-5/6 m-12 bg-[rgb(100,100,100)] rounded-xl hover:scale-105 duration-200 w-4/6'>
        ...
        <button 
        onClick={handleAdd}
        className='p-1 bg-yellow-100 hover:bg-yellow-200 hover:scale-105 rounded-lg w-fit mx-auto duration-200'
        >Add To Cart</button>
        <button
        onClick={handlePurchase}
        className='p-1 m-1 bg-yellow-100 hover:bg-yellow-200 hover:scale-105 rounded-lg w-fit mx-auto duration-200'
        >Buy Now</button>
      </div>
  )
}
